...
describe TypesController do
  ...
  let(:valid_attributes) { { "cat_id" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved type as @type" do
        ...
        post :create, {:type => { "cat_id" => "invalid value" }}, valid_session
        assigns(:type).should be_a_new(Type)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested type" do
        ...
        Type.any_instance.should_receive(:update_attributes).with({ "cat_id" => "MyString" })
        put :update, {:id => type.to_param, :type => { "cat_id" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the type as @type" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Type.any_instance.stub(:save).and_return(false)
        put :update, {:id => type.to_param, :type => { "cat_id" => "invalid value" }}, valid_session
        assigns(:type).should eq(type)
      end
