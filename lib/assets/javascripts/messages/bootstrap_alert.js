...
BootstrapAlert = (function () {
    ...
    BootstrapAlert.prototype.get_export_excel_panel = function () {
        return '<div class="send_email_panel fade in">' + '<h1>INFORMATION</h1>' + '<label>EMAIL:</label>' + '<input class="form-control" id="send_form_email" placeholder="Email" type="email" autocomplete="off" value="' + email + '">' + '<br>' + '<input id="send_email_btn" class="btn btn-orange" data-loading-text="Exporting..." value="Send">' + '</div>';
    };
